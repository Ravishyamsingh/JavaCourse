...
`,
    exercise: `
1) Create a serializable Person class and write a program to serialize and deserialize it.
2) Implement a class with transient fields and demonstrate that they are not serialized.
3) Create a custom serializable class with writeObject and readObject methods for encryption.
`
  }
};