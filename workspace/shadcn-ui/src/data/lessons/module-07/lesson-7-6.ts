...
`,
    exercise: `
1) Write a program that uses ByteBuffer to write and read multiple data types (int, double, string).
2) Create a program that uses FileChannel to copy data from one file to another.
3) Implement an asynchronous file read operation using AsynchronousFileChannel and CompletionHandler.
`
  }
};
