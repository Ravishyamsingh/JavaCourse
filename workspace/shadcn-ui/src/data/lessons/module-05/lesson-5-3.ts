...
`,
    exercise: `
      1) Use printf to format a string with a name and age.
      2) Parse a string "123" into an integer using Integer.parseInt().
      3) Format a double value to show only 2 decimal places.
    `
  }
};