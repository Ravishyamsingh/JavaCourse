...
`,
    exercise: `
1. Create a method that accepts a List<? extends Number> and prints all elements.
2. Create a method that accepts a List<? super Integer> and adds integers to it.
3. Create a method that accepts a List<?> and prints the size of the list.
4. Create a generic class with a bounded type parameter that extends Number.
5. Write a method that swaps two elements in a List<?> using wildcard capture.
`
  }
};