...
export const lesson_19_1: LessonContent = {
  ...
  content: {
    ...
    codeExample: '// Project Planning Models and Services\n\n' +
      ...
      '}',
    exercise: `
1) Create a RequirementsDocument class with methods to add functional and non-functional requirements.
2) Implement a Stakeholder class with properties for name, role, contact, and influence level.
3) Write a ProjectPlanningService that can estimate project complexity based on requirements.
4) Create a TechnologyStack class that recommends appropriate technologies for different project types.
5) Implement a risk assessment method that identifies and categorizes project risks.
`
  }
};